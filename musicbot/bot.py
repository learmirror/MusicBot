...
class MusicBot(discord.Client):
    ...
    async def cmd_tidus(self, channel):
            """
            Usage:
            {command_prefix}tidus
            <HAHAHAHA>
            """ 
            await self.safe_send_message(channel, "http://37.media.tumblr.com/f3b7827a1a2f8fd42ff1c6010ff49167/tumblr_n3r0a49fGG1sthzylo1_250.gif")
	
    async def cmd_supreme(self, channel):
            """
            Usage:
            {command_prefix}supreme
            <AERITH OR DISBAND>
            """ 
